...
$live_bid = App\Models\AuctionItem::where([
['bidding_staus', '=', 'live']
])
->where(function ($query) {
$query->whereJsonContains('total_bid', ['user_id' => '$user_id']);
})
->count();

$item_bought = App\Models\AuctionItem::where([
['bidding_staus', '=', 'closed'],
['bidder', '=', $user_id],
])
->count();

$price_item = App\Models\AuctionItem::where([
['bidding_staus', '=', 'closed'],
['bidder', '=', $user_id],
])
->latest('updated_at')
->value('price_collected');
           ...
           @include('pages.backend.dashboard.aux_pages.side_bar')
            <div class="col-lg-8">
                    ...
                    <div class="row justify-content-center mb-30-none">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="dashboard-item">
                                ...
                                <div class="content">
                                    <h2 class="title"><span class="counter">{{ $item_bought }}</span></h2>
                                    <h6 class="info">Items Bought</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="dashboard-item">
                                ...
                                <div class="content">
                                    <h2 class="title"><span class="counter">{{ $price_item }}</span></h2>
                                    <h6 class="info">Last Bought Item Price</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="dashboard-widget">
                    <h5 class="title mb-10">Purcahse history of last 5 days</h5>
