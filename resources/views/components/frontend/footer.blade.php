            ...
            <div class="newslater-area">
                ...
                <div class="newslater-content">
                    <div class="section-header left-style mb-low">
                        <h5 class="cate">Subscribe to UIU Auction</h5>
                        ...
                        <ul class="links-list">
                            ...
                            <li>
                                <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__"
                                        data-cfemail="e48c818894a4818a838b908c818981ca878b89">[email&#160;protected]</span></a>
                            </li>
                            <li>
        ...
        <div class="container">
            <div class="copyright-area">
                <div class="footer-bottom-wrapper">
                    <div class="logo">
                        <a href="{{ route('welcome') }}"><img src="{{ asset('assets/images/logo/footer-logo.png') }}" alt="logo"></a>
                    </div>
